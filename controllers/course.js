...
export const checkout = TryCatch(async (req, res) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: 'payment',
      success_url: `${process.env.frontendurl}/payment-success/${course._id}`, // Replace with your success URL
      cancel_url: `${process.env.frontendurl}/course/${course._id}`, // Replace with your cancel URL
    });
